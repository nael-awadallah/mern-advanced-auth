...
const EmailVerificationPage = () => {
  ...
  return (
    <div className='bg-gray-800 bg-opacity-50 shadow-xl backdrop-filter backdrop-blur-xl rounded-2xl w-full max-w-md overflow-hidden'>
      <motion.div
        initial={{ opacity: 0, y: -50 }}
        animate={{ opacity: 1, y: 0 }}
        transition={{ duration: 0.5 }}
        className='bg-gray-800 bg-opacity-50 shadow-2xl backdrop-filter backdrop-blur-xl p-8 rounded-2xl w-full max-w-md'>
          ...
          <div className='flex justify-between'>
            {code.map((digit, index) => (
              <input
                ...
                className='bg-gray-700 border-2 border-gray-600 focus:border-green-500 rounded-lg focus:outline-none w-12 h-12 font-bold text-white text-2xl text-center'
              />
            ))}
          </div>
